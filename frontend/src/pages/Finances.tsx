        ...
        <div className="card-dark">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 uppercase tracking-wider">Paid Bookings</p>
            </div>
          </div>
        </div>
        <div className="card-dark">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-700/50">
                  ...
                  <th className="text-right py-3 px-4 text-gray-500 font-medium">Avg / Booking</th>
                </tr>
              </thead>
              <tbody>
                {roomRevenue.map(({ room, totalBookings, paidBookings, revenue }) => {
                  ...
                  return (
                    <tr key={room.id} className="border-b border-gray-800/50 hover:bg-white/5">
                      ...
                      <td className="py-3 px-4 text-right text-gray-400">
                        R{paidBookings > 0 ? Math.round(revenue / paidBookings).toLocaleString() : '0'}
                      </td>
                    </tr>
                  )
                })}
